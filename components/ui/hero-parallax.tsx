  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 text-neutral-200">
        Yapay zeka ile saniyeler içinde profesyonel YouTube scriptleri, TikTok içerikleri ve SEO paketleri üretin. 
        En gelişmiş AI teknolojisi ile içerik üretiminde yeni bir çağ başlıyor.
      </p>
    </div>
  );
};
